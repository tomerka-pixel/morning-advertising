...
5. **ACCESS_CODE** — קוד סודי שתבחר (למשל מחרוזת אקראית). רק בקשות עם הקוד הזה יורשו לייצר.
   בפעם הראשונה שתיצור בלינק הציבורי, הדפדפן יבקש את הקוד וישמור אותו במחשב שלך. כך רק אתה מייצר.
